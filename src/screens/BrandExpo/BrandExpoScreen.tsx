...
import { KeyboardAvoidingComponent } from "../../components/shared/KeyboardAvoidingComponent";
    ...
    <ScrollView style={{ flex: 1 }}>
      <View>
        <DefaultPaddingComponent>
          <TitleComponent>This is a title</TitleComponent>

          <SubTitleComponent>This is a sub title</SubTitleComponent>

          <IngressComponent>This is a text ingress</IngressComponent>

          <TextComponent>
            This is normal text. Lorem ipsum dolor sit amet, consectetur
            adipiscing elit. Etiam pellentesque massa vel velit fermentum, sed
            vestibulum augue egestas. Aenean blandit nisl ac mi tempor, a
            vestibulum mi malesuada. Cras hendrerit, massa et semper interdum,
            lacus turpis rutrum arcu, in sagittis nisl dui at eros. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Phasellus vitae turpis
            ex. Praesent tellus est, placerat quis hendrerit in, gravida id
            libero. Vivamus posuere a magna sed posuere. Maecenas sagittis
            porttitor malesuada. Phasellus auctor purus vel volutpat posuere.
            Nam quis ipsum quis ipsum sollicitudin dapibus. Donec gravida
            viverra nulla, in porttitor tortor gravida at. Aenean nunc nibh,
            convallis non commodo tincidunt, porta iaculis odio. Pellentesque
            non sem fringilla, posuere neque ac, mattis nulla.
          </TextComponent>

          <DividerComponent />
          <KeyboardAvoidingComponent useScroll={false} useBehavior={false}>
            <SubTitleComponent>Forms</SubTitleComponent>
          ...
          >
            {["BMW", "Porsche", "Volvo", "Bentley", "Mercedes"].map((brand) => (
              <Picker.Item key={brand} label={brand} value={brand} />
            ))}
          </Picker>

          <SubTitleComponent>Chips</SubTitleComponent>

          <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
            {["BMW", "Porsche", "Volvo", "Bentley", "Mercedes"].map(
              (brand, index) => (
          ...
          <SubTitleComponent>Buttons</SubTitleComponent>
          ...
          <SubTitleComponent>Button pairs</SubTitleComponent>
          ...
          <SubTitleComponent>Dates</SubTitleComponent>
          ...
          <SubTitleComponent>Dialogues</SubTitleComponent>

          <NblocksButton
            type="primary"
            title="Show confirmation dialogue"
            onPress={() =>
              DialogueService.showConfirmation(
                "Confirm",
                "This is a confirmation dialogue. Click Cancel or OK",
                "Ok",
                () => {}
              )
            }
          ...
          <SubTitleComponent>Modals</SubTitleComponent>

          <NblocksButton
            type="primary"
            title="Open (half) modal #1"
            onPress={() => setHalfModalVisible(true)}
          ></NblocksButton>
          <NblocksButton
            type="primary"
            title="Open (full) modal #2"
            onPress={() => setFullModalVisible(true)}
          ></NblocksButton>

          <SubTitleComponent>Table</SubTitleComponent>
          {/* <UserListComponent></UserListComponent> */}

          <SubTitleComponent>Loading</SubTitleComponent>
          <View>
            <ActivityIndicator color="#32B768" size="large" />
          </View>

          <SubTitleComponent>UI helpers</SubTitleComponent>
          <AccessControllComponent roles={["OWNER"]}>
            <TextComponent>
              AccessControllComponent : This text is only visible if you're an
              Owner
            </TextComponent>
      ...
      <NblocksModalComponent
        ...
        mode="half"
        onCloseModal={() => setHalfModalVisible(false)}
        swipable={false}
      >
        <View style={{ flex: 1, alignContent: "stretch" }}>
          <TitleComponent>Half modal</TitleComponent>
          <TextComponent style={{ flex: 1 }}>
            This is a "half" modal. Tap the outer area to close or use
            buttons...
          </TextComponent>
          <SubmitCancelButtonsComponent
            submitText="Close"
      ...
      >
        <View style={{ flex: 1, alignContent: "stretch" }}>
          <TitleComponent>This is a full modal</TitleComponent>
          <TextComponent style={{ flex: 1 }}>
